...
router.get('/newOrder', (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var order;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, getNewOrder(req)];
            case 1:
                order = _a.sent();
                if (order)
                    res.send(order);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, getNewOrder(req)];
            case 1:
                order = _a.sent();
                if (!order) {
